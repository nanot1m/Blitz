...
const wasmExports = [
  ...
  "blitz_add_triangle",
  "blitz_add_text",
  "blitz_duplicate_selected",
  "blitz_copy_selected_to_internal_clipboard",
  "blitz_internal_clipboard_bounds_ptr",
  "blitz_internal_clipboard_count",
  "blitz_paste_internal_clipboard",
  "blitz_clear_scene",
  "blitz_load_demo_template",
  "blitz_clear_selection",
  "blitz_select_object",
  "blitz_set_relative_transform",
  "blitz_clear_relative_transform",
  "blitz_set_container",
  "blitz_set_selected_container",
  "blitz_selected_container_state",
  "blitz_create_rect",
  "blitz_create_frame",
  "blitz_create_circle",
  "blitz_create_oval",
  ...
  "blitz_selected_frame_title_ptr",
  "blitz_selected_frame_title_length",
  "blitz_set_selected_frame_title",
  "blitz_select_all",
